...
class Woo_KigoCloud {
	...
	private function define_public_hooks() {
		...
		// Anchor price under the product price (_kigo_anchor_price meta from KigoCloud).
		$this->loader->add_filter( 'woocommerce_get_price_html', $plugin_public, 'anchor_price_html', 20, 2 );
